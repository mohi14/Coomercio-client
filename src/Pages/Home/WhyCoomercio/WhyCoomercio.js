        ...
        <div className='my-28 max-w-[1500px] m-auto'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-4 gap-10 my-16'>
                <div className='text-center lg:col-span-2 p-10'>
                    ...
                    <p>We began Coomercio back in 2018 to give used laptops a new life. Since then, we've saved thousands of  laptops and more from landfills, and paid our customers in the process.</p>
                </div>
                <div className='text-center lg:col-span-2 p-10'>
                    ...
                    <p>All our laptops are inspected thoroughly to guarantee 100% functionality. Listings show pictures of the actual item you'll receive. Not a generic picture.</p>
                </div>
                <div className='text-center lg:col-start-2 lg:col-span-2 p-10'>
                    ...
                    <p>One main reason: to significantly save you money while reducing your carbon footprint. Resell, reuse, reduce. That's our motto.</p>
                </div>
            </div>
        </div>
    );
