...
const Footer = () => {
    return (
        <div className='shadow bg-primary text-white lg:h-80 lg:flex items-center'>
            <footer className="lg:pl-32 footer p-10  text-white max-w-[1440px] m-auto text-lg">
                <div>
                    <span className="footer-title">Quick Links</span>
                    <Link className="link link-hover">Rental</Link>
